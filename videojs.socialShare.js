  ...
  videojs.plugin('socialShare', function(opts) {
    ...
    function constructSocialShareContent() {
      ...
      if (opts.video_name) {
        ...
        _name.style.height = "40px";
        _name.style.lineHeight = "40px";
        _name.style.float = "left";
        _name.style.width= "70%";
        _name.style.marginLeft = "10px";
        _name.style.fontSize = "2em";
        _name.style.textAlign = "left";
        _name.className = 'vjs-video-name';
        _name.innerHTML = opts.video_name.name;
        _aside.appendChild(_name);
      };
      ...
      if (opts.facebook) {
        ...
        _button.style.float= "right";
        _button.style.marginRight = "10px";
